...
const messages = {
  "zh-TW": {
    ...
    menuBrandEyebrow: "WANDERING SWORD",
    menuHubMetaSection: "聲望進度",
    menuHubRunSection: "入局設定",
    menuHubDifficultyRow: "江湖難度",
    menuHubRunSummary: "難度 {difficulty} · {style} · {modifier} · {title}",
    menuHubCoupletLeft: "劍氣縱橫",
    menuHubCoupletRight: "笑傲江湖",
    collectionSubtitle: "招式譜 · 宿敵錄 · 聲望志",
    gameOverSealVictory: "勝",
    gameOverSealDefeat: "敗",
    ...
    menuHubRenownShort: "{title} · {renown}",
    menuHubShopShort: "商店",
    menuHubCodexShort: "圖鑑",
    ...
    recommendedBadge: "推薦",
    recommendCompletesRecipe: "臨門一悟：{art} {current}/{total}",
    recommendNearRecipe: "接近絕學：{art} {current}/{total}",
    recommendBuildPath: "{path} 可助你走向 {art}",
    sealUpgrade: "封印",
    sealedUpgradeToast: "封印：{name}",
    banishRemaining: "封印令 x{count}",
    unknownUltimateArt: "未悟出的絕學",
    hiddenHeartMethod: "隱藏心法",
    codexRecipeDiscovered: "{weapon} 第 {weaponLevel} 層 + {skill} 第 {skillLevel} 層\n流派：{buildPath}",
    codexRecipeHidden: "{weapon} 第 {weaponLevel} 層 + {skill} 第 {skillLevel} 層\n線索：{buildPath}",
    bossUnlockNone: "無心法傳承",
    unknownBossRecord: "未破之敵",
    bossUnlockDetail: "戰績：{status}\n江湖傳承：{unlocks}",
    codexDetailHint: "武學詳解",
    codexDetailEmpty: "點選絕學或強敵，查看配方與傳承。",
    ...
    combatCrit: "暴擊",
    combatCombo: "連擊",
    combatDrain: "吸血 +{amount}",
    evolutionLearnedBanner: "領悟絕學",
    ...
    statusPanelHintTouch: "點擊空白處關閉",
    statusSectionRun: "本局戰況",
    statusSectionVitals: "氣血內力",
    statusSectionCombat: "戰鬥屬性",
    statusSectionBuild: "流派造詣",
    statusSectionEvolution: "絕學進度",
    statusRunLine: "等級 {level}   聲望 {renown}   擊敗 {kills}\n時間 {time}   難度 {difficulty}   {title}",
    statusHpLine: "氣血 {hp}/{maxHp}",
    statusInnerForceLine: "內力 {innerForce}   武學層數 {layers}",
    statusDamageLine: "傷害倍率 {value}",
    statusCooldownLine: "冷卻倍率 {value}",
    statusProjectileSpeedLine: "招式速度 {value}",
    statusAreaLine: "攻擊範圍 {value}",
    statusCritLine: "暴擊率 {chance}   暴擊倍率 {multiplier}x",
    statusDodgeLine: "閃避率 {value}",
    statusComboLine: "連擊率 {value}",
    statusBurstLine: "爆發倍率 {value}",
    statusMoveSpeedLine: "移動速度 {value}",
    ...
    bossTechniqueFanStrike: "扇形劍氣",
    bossTechniqueSummon: "聚眾傳令",
    bossTechniqueNeedleStorm: "奪命繡花針",
    bossTechniquePursuitLock: "追擊鎖脈",
    bossTechniqueFanLinger: "劍氣殘留",
    bossTechniqueGuardFormation: "護法金剛陣",
    bossTechniqueSectorNeedle: "扇區針雨",
    bossTechniqueOrbitingNeedles: "繞場飛針",
    bossTechniqueFinalPhase: "東方不敗之勢",
    bossTierCaptain: "五嶽掌門",
    bossTierMaster: "絕學宗師",
    bossTierGrand: "一代宗師",
    bossTierLegendary: "魔教巨擘",
    bossTierSupreme: "武林至境",
    ...
    enemy_bat: "魔教刺客",
    enemy_golem: "嵩山高手",
    enemy_huashanSwordsman: "華山劍徒",
    enemy_hengshanNun: "恆山持戒尼",
    enemy_taishanAcolyte: "泰山門徒",
    enemy_riverBandit: "江湖水匪",
    enemy_medicineHeretic: "藥谷邪醫",
    enemy_sunMoonCultist: "日月教眾",
    enemy_royalGuard: "錦衣衛士",
    enemy_wudangMonk: "武當道士",
    enemy_shaolinMonk: "少林武僧",
    enemy_emeiDisciple: "峨眉劍姬",
    enemy_beggarSect: "丐幫弟子",
    enemy_northernRider: "塞北馬賊",
    enemy_poisonMaster: "五毒教徒",
    ...
    buildMilestoneBadge: "里程碑",
    evolutionPreviewReady: "可悟絕學：{name}",
    evolutionPreviewWeapon: "再升一層 {weapon} 可悟 {name}",
    evolutionPreviewSkill: "再升一層 {skill} 可悟 {name}",
    buildMilestone_swordSect_L3: "里程碑：劍意更銳",
    buildMilestone_swordSect_L5: "里程碑：暴擊時劍氣迸發",
    buildMilestone_swordSect_L8: "里程碑：劍意通神",
    buildMilestone_qiSect_L3: "里程碑：調息續戰",
    buildMilestone_qiSect_L5: "里程碑：氣場更廣",
    buildMilestone_qiSect_L8: "里程碑：氣海無量",
    buildMilestone_footworkSect_L3: "里程碑：身法更輕",
    buildMilestone_footworkSect_L5: "里程碑：閃避後疾行",
    buildMilestone_footworkSect_L8: "里程碑：凌波微步",
    buildMilestone_wineSwordSect_L3: "里程碑：酒意更酣",
    buildMilestone_wineSwordSect_L5: "里程碑：連擊催招",
    buildMilestone_wineSwordSect_L8: "里程碑：酒劍通神",
    skillUnlockedToast: "解鎖心法：{name}",
    potentialEvolutionToast: "可悟絕學：{name}",
    bossDefeatedReward: "{name} 伏誅，江湖聲望大振，真氣 +{exp}",
    pressureWaveStart: "圍攻潮起！江湖各派齊至",
    respiteStart: "伏魔喘息，真氣湧動",
    runEventAmbush: "伏擊！{name}來襲",
    runEventQiSurge: "奇遇：真氣湧動，修為加倍",
    runEventFormationLull: "奇遇：敵陣潰散，得以喘息",
    runEventHermitGift: "奇遇：高人饋贈，氣血回復",
    runEventBanditCache: "奇遇：發現匪徒藏酒",
    runModifierToast: "江湖際遇：{name}",
    runModifier_ironTrial_title: "鐵面試煉",
    runModifier_ironTrial_desc: "傷害 +12%，精英 +5%",
    runModifier_jadeFlow_title: "玉脈真氣",
    runModifier_jadeFlow_desc: "修為 +15%",
    runModifier_mistFoot_title: "霧隱身法",
    runModifier_mistFoot_desc: "移速 +14，閃避 +5%",
    runModifier_bloodOath_title: "血誓追獵",
    runModifier_bloodOath_desc: "聲望 +20%，敵速 +8%",
    runModifier_hermitGift_title: "隱士饋贈",
    runModifier_hermitGift_desc: "重抽 +1，傷害 -8%",
    runModifier_sectChase_title: "門派追剿",
    runModifier_sectChase_desc: "主題敵再來快 15%",
    bossBuildPathUnlock: "伏魔悟道：走上「{name}」",
    bossBuildPathLevel: "伏魔悟道：{name} 升至第 {level} 重",
    bossLegacyTitle: "江湖傳承：{boss}",
    bossLegacyBody: "心法：{skills}\n絕學線索：{routes}\n真氣 +{exp}   聲望 +{renown}",
    bossLegacyNoSkill: "無新心法",
    bossLegacyNoRoute: "未牽動絕學路線",
    achievementToast: "達成：{name}",
    recordLine: "最高難度 {difficulty}   最快通關 {fastest}\n成就 {achievements}",
    chronicleLine: "戰績簿：總聲望 {totalRenown}｜本局難度 {difficulty}｜倍率 {reward}%\n最高難度刷新：{newDifficulty}｜最快通關刷新：{newFastest}",
    newRecord: "新紀錄",
  ...
  en: {
    ...
    menuHubRunSummary: "Difficulty {difficulty} · {style} · {modifier} · {title}",
    menuHubCoupletLeft: "Sword Qi",
    menuHubCoupletRight: "Jianghu",
    collectionSubtitle: "Forms · Foes · Renown",
    gameOverSealVictory: "Win",
    gameOverSealDefeat: "Fall",
    ...
    menuHubRenownShort: "{title} · {renown}",
    menuHubShopShort: "Shop",
    menuHubCodexShort: "Codex",
    ...
    recommendCompletesRecipe: "One insight away: {art} {current}/{total}",
    recommendNearRecipe: "Near ultimate art: {art} {current}/{total}",
    recommendBuildPath: "{path} supports {art}",
    sealUpgrade: "Seal",
    sealedUpgradeToast: "Sealed: {name}",
    banishRemaining: "Seal Orders x{count}",
    unknownUltimateArt: "Unknown Ultimate Art",
    hiddenHeartMethod: "Hidden heart method",
    codexRecipeDiscovered: "{weapon} Lv.{weaponLevel} + {skill} Lv.{skillLevel}\nPath: {buildPath}",
    codexRecipeHidden: "{weapon} Lv.{weaponLevel} + {skill} Lv.{skillLevel}\nClue: {buildPath}",
    bossUnlockNone: "No heart-method legacy",
    unknownBossRecord: "Unbroken Rival",
    bossUnlockDetail: "Record: {status}\nJianghu legacy: {unlocks}",
    codexDetailHint: "Martial Detail",
    codexDetailEmpty: "Select an ultimate art or rival to inspect recipes and legacies.",
    ...
    pauseHintTouch: "Tap to resume",
    hudPauseButton: "Pause",
    hudStatusButton: "Status",
    loadoutSlots: "{current}/{max}",
    loadoutSectionLabel: "{name} {current}/{max}",
    loadoutTier: "Tier {tier}",
    loadoutEvolvedTier: "Ult",
    loadoutAwaiting: "—",
    ...
    combatCrit: "Crit",
    combatCombo: "Combo",
    combatDrain: "Drained +{amount}",
    evolutionLearnedBanner: "Ultimate Mastered",
    ...
    statusPanelHintTouch: "Tap empty space to close",
    statusSectionRun: "Current Run",
    statusSectionVitals: "Vitals",
    statusSectionCombat: "Combat Stats",
    statusSectionBuild: "Build Paths",
    statusSectionEvolution: "Ultimate Progress",
    statusRunLine: "Lv {level}   Renown {renown}   Kills {kills}\nTime {time}   Difficulty {difficulty}   {title}",
    statusHpLine: "HP {hp}/{maxHp}",
    statusInnerForceLine: "Inner Force {innerForce}   Martial Layers {layers}",
    statusDamageLine: "Damage {value}",
    statusCooldownLine: "Cooldown {value}",
    statusProjectileSpeedLine: "Projectile Speed {value}",
    statusAreaLine: "Area {value}",
    statusCritLine: "Crit {chance}   Crit Mult {multiplier}x",
    statusDodgeLine: "Dodge {value}",
    statusComboLine: "Combo {value}",
    statusBurstLine: "Burst {value}",
    statusMoveSpeedLine: "Move Speed {value}",
    ...
    bossTechniqueFanStrike: "Fan Sword Qi",
    bossTechniqueSummon: "Sect Rallying Rite",
    bossTechniqueNeedleStorm: "Lethal Embroidery Needles",
    bossTechniquePursuitLock: "Pursuit Lock Rush",
    bossTechniqueFanLinger: "Lingering Fan Qi",
    bossTechniqueGuardFormation: "Guardian Vajra Array",
    bossTechniqueSectorNeedle: "Sector Needle Rain",
    bossTechniqueOrbitingNeedles: "Orbiting Flying Needles",
    bossTechniqueFinalPhase: "Eastern Invincible Stance",
    bossTierCaptain: "Sect Captain",
    bossTierMaster: "Renegade Master",
    bossTierGrand: "Grand Elder",
    bossTierLegendary: "Demonic Overlord",
    bossTierSupreme: "Supreme Foe",
    ...
    enemy_huashanSwordsman: "Huashan Sword Trainee",
    enemy_hengshanNun: "Hengshan Guard Nun",
    enemy_taishanAcolyte: "Taishan Acolyte",
    enemy_riverBandit: "River Bandit",
    enemy_medicineHeretic: "Medicine Valley Heretic",
    enemy_sunMoonCultist: "Sun Moon Cultist",
    enemy_royalGuard: "Imperial Brocade Guard",
    enemy_wudangMonk: "Wudang Taoist",
    enemy_shaolinMonk: "Shaolin Monk",
    enemy_emeiDisciple: "Emei Sword Maiden",
    enemy_beggarSect: "Beggar Sect Scout",
    enemy_northernRider: "Northern Steppe Raider",
    enemy_poisonMaster: "Five Poisons Cultist",
    ...
    buildMilestoneBadge: "Milestone",
    evolutionPreviewReady: "Ready to master: {name}",
    evolutionPreviewWeapon: "One more {weapon} level unlocks {name}",
    evolutionPreviewSkill: "One more {skill} level unlocks {name}",
    buildMilestone_swordSect_L3: "Milestone: sharper sword intent",
    buildMilestone_swordSect_L5: "Milestone: crits burst with sword qi",
    buildMilestone_swordSect_L8: "Milestone: sword intent perfected",
    buildMilestone_qiSect_L3: "Milestone: steady inner-force recovery",
    buildMilestone_qiSect_L5: "Milestone: wider qi field",
    buildMilestone_qiSect_L8: "Milestone: boundless qi sea",
    buildMilestone_footworkSect_L3: "Milestone: lighter footwork",
    buildMilestone_footworkSect_L5: "Milestone: dodge into a sprint",
    buildMilestone_footworkSect_L8: "Milestone: wave-skimming step",
    buildMilestone_wineSwordSect_L3: "Milestone: deeper wine fire",
    buildMilestone_wineSwordSect_L5: "Milestone: combos shave cooldowns",
    buildMilestone_wineSwordSect_L8: "Milestone: wine sword perfected",
    ...
    pressureWaveStart: "Siege wave! Factions converge",
    respiteStart: "Brief reprieve — qi surges",
    runEventAmbush: "Ambush! {name} strikes",
    runEventQiSurge: "Encounter: qi surge — double cultivation",
    runEventFormationLull: "Encounter: enemy lines break — brief calm",
    runEventHermitGift: "Encounter: hermit's gift restores vigor",
    runEventBanditCache: "Encounter: bandit wine stash found",
    runModifierToast: "Jianghu encounter: {name}",
    runModifier_ironTrial_title: "Iron Trial",
    runModifier_ironTrial_desc: "+12% damage, +5% elites",
    runModifier_jadeFlow_title: "Jade Flow",
    runModifier_jadeFlow_desc: "+15% cultivation",
    runModifier_mistFoot_title: "Mist Foot",
    runModifier_mistFoot_desc: "+14 speed, +5% dodge",
    runModifier_bloodOath_title: "Blood Oath",
    runModifier_bloodOath_desc: "+20% renown, +8% enemy speed",
    runModifier_hermitGift_title: "Hermit Gift",
    runModifier_hermitGift_desc: "+1 reroll, -8% damage",
    runModifier_sectChase_title: "Sect Chase",
    runModifier_sectChase_desc: "Themed foes respawn 15% faster",
    bossBuildPathUnlock: "Boss insight: enter {name}",
    bossBuildPathLevel: "Boss insight: {name} reaches Lv.{level}",
    bossLegacyTitle: "Jianghu Legacy: {boss}",
    bossLegacyBody: "Heart methods: {skills}\nUltimate clues: {routes}\nQi +{exp}   Renown +{renown}",
    bossLegacyNoSkill: "No new heart method",
    bossLegacyNoRoute: "No ultimate route stirred",
    achievementToast: "Achievement: {name}",
    recordLine: "Highest Difficulty {difficulty}   Fastest Clear {fastest}\nAchievements {achievements}",
    chronicleLine: "Chronicle: Total Renown {totalRenown} | Run Difficulty {difficulty} | Multiplier {reward}%\nHighest difficulty record: {newDifficulty} | Fastest clear record: {newFastest}",
